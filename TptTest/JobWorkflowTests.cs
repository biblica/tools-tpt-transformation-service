    ...
    public class JobWorkflowTests
    {
        ...
        public void TestRunJobSuccess()
        {
            ...
            _mockScriptRunner.Setup(runnerItem =>
                runnerItem.CreatePreview(testPreviewJob, It.IsAny<string[]>(), It.IsAny<string>(), It.IsAny<CancellationToken?>()))
            ...
            _mockScriptRunner.Verify(runnerItem =>
                runnerItem.CreatePreview(testPreviewJob, It.IsAny<string[]>(), It.IsAny<string>(), It.IsAny<CancellationToken?>()), Times.Once);
