 ...
 * @param {string} footnotes CSV string of footnotes.
 */
function addCustomFootnotes(doc, footnotes) {
    ...
    //footnotes = "а, б, в, г, д, е, ж, з, и, й, к, л, м, н, о, п, р, с, т, у, ф, х, ц, ч, ш, щ, ы, э, ю, я";
    var symbols = footnotes
        .replace(",", "")
        .replace(" ", "");
